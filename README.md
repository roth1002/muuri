...
Muuri uses CSS transitions to animate the grid items (positioning/showing/hiding) and [Hammer.js](http://hammerjs.github.io/) for handling the dragging. And if you're wondering about the name of the library "muuri" is Finnish meaning a wall.
...
* The item elements must not have any CSS transitions or animations applied to them, because they might conflict with internal animation engine. However, the grid container element can have transitions applied to it if you want it to animate when it's size changes after the layout operation.
...
Show animation easing. Accepts any valid [CSS transition easing](https://developer.mozilla.org/en/docs/Web/CSS/transition-timing-function) value.
...
Hide animation easing. Accepts any valid [CSS transition easing](https://developer.mozilla.org/en/docs/Web/CSS/transition-timing-function) value.
...
The easing for item's layout animation. Accepts any valid [CSS transition easing](https://developer.mozilla.org/en/docs/Web/CSS/transition-timing-function) value.
...
The easing for item's drag release animation. Accepts any valid [CSS transition easing](https://developer.mozilla.org/en/docs/Web/CSS/transition-timing-function) value.
...
* Big thanks to the people behind [Hammer.js](http://hammerjs.github.io/) for providing such an awesome touch event library.
